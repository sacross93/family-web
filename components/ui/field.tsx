...
const FIELD_BASE =
  "w-full rounded-md border border-line-strong bg-surface px-4 text-[0.9375rem] text-ink placeholder:text-ink-faint outline-none transition focus:border-primary focus:ring-4 focus:ring-primary-soft";
